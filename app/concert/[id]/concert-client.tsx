				...
				{isFuture ? (
					...
					<div className="border-l-2 border-[#FFC24B]/40 bg-[#FFC24B]/[0.04] py-5 pl-5 pr-4">
						<div className="flex items-center gap-2 text-[#FFC24B]">
							...
							<span className="font-semibold [font-family:var(--font-display)]">
								{rsvps.length === 0 ? "Sei tra i primi" : "Ci sarai?"}
							</span>
						</div>
					...
					<div className="flex flex-wrap items-center gap-4 border-l-2 border-[#FF2D6B]/40 bg-white/[0.02] py-4 pl-5">
						{avg ? (
							...
							<span className="text-sm text-white/50">Ancora nessun voto — sii il primo a votare</span>
						)}
					</div>
				)}
