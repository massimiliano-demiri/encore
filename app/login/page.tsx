		...
		<main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
			...
			<div className="relative w-full max-w-sm">
				...
				<div className="mt-4 flex flex-col items-center gap-2">
					<Link href="/login/magic" className="inline-flex items-center gap-1 text-xs text-white/35 hover:text-white/60 transition">
						<Sparkles className="h-3 w-3" /> Entra senza password
					</Link>
					<p className="text-sm text-white/40">
						Non hai un account?{" "}
						<Link href="/signup" className="text-[#FF2D6B] hover:underline">Registrati</Link>
					</p>
				</div>
			</div>
		</main>
